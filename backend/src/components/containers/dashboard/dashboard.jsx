            ...
            <div className="content-wrapper">                
                ...
                <div className="row">
                    ...
                    <div className="box box-success">
                        ...
                        <div className="item">
                            <img src="assets/dist/img/user4-128x128.jpg" alt="user" className="online"/>
                        ...
                        <div className="item">
                            <img src="assets/dist/img/user3-128x128.jpg" alt="user" className="offline"/>
                        ...
                        <div className="item">
                            <img src="assets/dist/img/user2-160x160.jpg" alt="user" className="offline"/>
                    ...
                    <div className="box box-solid bg-green-gradient">
                        ...
                        <div className="pull-right box-tools">
                            ...
                            <ul className="dropdown-menu pull-right" role="menu">
                                <li><Link to="#">Add new event</Link></li>
                                <li><Link to="#">Clear events</Link></li>
                                <li className="divider"></li>
                                <li><Link to="#">View calendar</Link></li>
                            </ul>
                            </div>
